      ...
      <div className="relative mx-auto max-w-5xl space-y-32 px-6 py-24 md:py-32">
        ...
        <header className="animate-in fade-in slide-in-from-bottom-4 mb-24 space-y-8 duration-1000">
          <div className="group relative inline-block">
            {/* Tagline */}
            <div className="mb-6 flex items-center gap-3 font-mono text-xs font-bold tracking-[0.2em] text-cyan-500 uppercase">
            ...
            <h1 className="max-w-4xl bg-gradient-to-r from-white via-zinc-200 to-zinc-500 bg-clip-text pb-2 text-6xl font-black tracking-tight text-transparent sm:text-8xl">
              Core Operation <br />
              <span className="bg-gradient-to-r from-cyan-400 via-violet-400 to-fuchsia-400 bg-clip-text font-serif text-transparent italic">
                Modules.
              </span>
            </h1>
...
function SectionHeader({ title }: { title: string }) {
  return (
    <div className="mb-12 flex items-center gap-4">
      <div className="h-px max-w-[50px] flex-1 bg-gradient-to-r from-zinc-800 to-zinc-500" />
